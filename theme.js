...
const GOLDMIND_THEMES = {
  'royal-gold': {
    ...
    vars: {
      '--gm-bg': '#0f172a',
      '--gm-bg-elevated': '#eef1f7',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#e5eaf2',
      '--gm-primary': '#000000',
  ...
  'deep-teal': {
    ...
    vars: {
      '--gm-bg': '#0d2b30',
      '--gm-bg-elevated': '#dcefee',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#cfe8e6',
      '--gm-primary': '#0d2b30',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#C9A227',
      '--gm-on-accent': '#0d2b30',
  ...
  'night-cyan': {
    ...
    vars: {
      '--gm-bg': '#0a1420',
      '--gm-bg-elevated': '#d9eef2',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#cbe6ec',
      '--gm-primary': '#0a1420',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#00E0EF',
      '--gm-on-accent': '#0a1420',
  ...
  'light-gold': {
    ...
    vars: {
      '--gm-bg': '#1c1710',
      '--gm-bg-elevated': '#f0e6cf',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#e8dbb8',
      '--gm-primary': '#191c1e',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#B4955A',
      '--gm-on-accent': '#ffffff',
  ...
  'rose-gold': {
    ...
    vars: {
      '--gm-bg': '#2b1620',
      '--gm-bg-elevated': '#f5dde0',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#efd0d4',
      '--gm-primary': '#2b1620',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#B76E79',
      '--gm-on-accent': '#ffffff',
  ...
  'platinum-silver': {
    ...
    vars: {
      '--gm-bg': '#14181c',
      '--gm-bg-elevated': '#dfe4e8',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#ccd3d9',
      '--gm-primary': '#14181c',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#9FA8B0',
      '--gm-on-accent': '#14181c',
  ...
  'emerald': {
    ...
    vars: {
      '--gm-bg': '#0a1f14',
      '--gm-bg-elevated': '#d3ecdb',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#bfe4cb',
      '--gm-primary': '#0a1f14',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#0F9D58',
      '--gm-on-accent': '#ffffff',
  ...
  'royal-purple': {
    ...
    vars: {
      '--gm-bg': '#1a1024',
      '--gm-bg-elevated': '#e5dcf4',
      '--gm-surface-lowest': '#ffffff',
      '--gm-surface-low': '#d7c9ee',
      '--gm-primary': '#1a1024',
      '--gm-on-primary': '#ffffff',
      '--gm-accent': '#8B5CF6',
      '--gm-on-accent': '#ffffff',
